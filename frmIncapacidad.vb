Public Class frmIncapacidad
    ...
    Private Sub frmIncapacidad_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ListarIncapacidad()
    ...
    Function calculofechafinal(fechainicio As Date, dias As Integer) As String
    ...
    Private Sub MostrarDatosIcapacidad(id As String)
        Dim sql As String
        IdIncapacidad = id
    ...
    Private Sub lsvLista_ItemActivate1(sender As Object, e As System.EventArgs) Handles lsvLista.ItemActivate
        If lsvLista.SelectedItems.Count > 0 Then
            MostrarDatosIcapacidad(lsvLista.SelectedItems(0).Tag)
        End If
    End Sub

    Private Sub lsvLista_SelectedIndexChanged_1(sender As System.Object, e As System.EventArgs) Handles lsvLista.SelectedIndexChanged
